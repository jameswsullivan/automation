...
# using command: "mkdir {starting_year..ending_year}" , e.g. mkdir {2020..2024}
# To batch move the .csv files generated by the "[dspace]/bin/dspace solr-export-statistics" command, use the following command:

# for year in {2020..2024}; do
#     mv "statistics_export_${year}"*.csv "$year"/
# done
